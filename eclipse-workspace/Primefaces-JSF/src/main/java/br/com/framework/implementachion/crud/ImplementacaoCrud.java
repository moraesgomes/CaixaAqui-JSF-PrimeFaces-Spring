package br.com.framework.implementachion.crud;
...
public class ImplementacaoCrud<T> implements InterfaceCrud<T> {
	...
	private static SessionFactory sessionFactory = HibernateUseful.getSessionFactory();
	...
	private void validaSessionFactory() {
		if (sessionFactory == null) {
			sessionFactory = HibernateUseful.getSessionFactory();
		}
		validaTransaction();
	}
