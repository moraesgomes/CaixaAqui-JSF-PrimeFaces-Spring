...
import br.com.framework.implementachion.crud.VariableConnectionUseful;
 ...
 */
@ApplicationScoped
public class HibernateUseful implements Serializable{
    ...
    public DataSource getDataSourceJndi () throws NamingException{
    	...
    	return (DataSource) context.lookup(VariableConnectionUseful.JAVA_COMP_ENV_JDBC_DATA_SOURCE);
