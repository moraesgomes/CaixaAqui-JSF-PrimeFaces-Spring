...
public class MensagemBeanView extends BeanManagedViewAbstract {
	...
	public void saveNotReturn() throws Exception {
		...
		if(objetoSelecionado.getUser_destino().getEnt_codigo().equals(objetoSelecionado.getUser_origem().getEnt_codigo())) {
	...
	public void buscarUsuarioDestinoMsg(HttpServletResponse httpServletResponse , @RequestParam(value ="codEntidade") Long codEntidade)
			throws Exception {
